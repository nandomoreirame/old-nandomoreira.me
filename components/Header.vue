  ...
  <header class="header header--fixed" :class="{ 'header--up': $store.state.headerUp }">
    <div class="container">
      <div class="header__inner">
        <navbar/>
        <link-button buttonType="whatsapp" buttonSize="small" buttonPermalink="https://api.whatsapp.com/send?1=pt_BR&amp;phone=5541984401163" :nuxtLink="false" linkTarget="_blank">
          ...
          Quer bater um papo? <span>Então cola ae!</span>
        </link-button>
      </div>
    </div>
  </header>

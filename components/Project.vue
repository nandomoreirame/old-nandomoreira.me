          ...
          <div class="project__meta">
            ...
            <span class="project__tags">
              ...
              <small v-for="(tag, tagKey) in project.tags" :key="tagKey">
                <a :href="`https://twitter.com/intent/tweet?text=Veja o projeto: ${project.name} feito por @oseunando em:&url=https://nandomoreira.me/projetos&hashtags=${tag}`" target="_blank">
                  #{{ tag }}
                </a>
              </small>
            </span>

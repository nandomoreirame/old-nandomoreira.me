<template>
  <div class="error404">
    <div v-if="error.statusCode === 404" class="error404__inner">
    ...
    <div v-else class="error404__inner">
...
<script>
  export default {
    ...
    data () {
      return {
        pageTitle: `Oops, ocorreu um erro Ô.ô | Fernando Moreira`,
...
<style lang="stylus">
@import '~assets/stylus/layouts/_error.styl'
</style>
